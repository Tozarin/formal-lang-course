...
def gen_labeled_two_cycles_graph(num_nodes: Tuple[int, int], marks: Tuple[str, str]) -> MultiDiGraph:
    return labeled_two_cycles_graph(num_nodes[0], num_nodes[1], labels=marks)
