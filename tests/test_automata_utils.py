...
from project.utils.graph_utils import gen_labeled_two_cycles_graph, load_from_dot, get_graph
from project.utils.automata_utils import gen_min_dfa_by_reg, gen_nfa_by_graph, AutomataExepction
...
def test_fail_gen_nfa_by_graph():
    ...
    count_of_nodes = 10
    gr = gen_labeled_two_cycles_graph(count_of_nodes // 2, count_of_nodes // 2, ("a", "b"))
